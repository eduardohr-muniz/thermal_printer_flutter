...
void main() {
  ...
  group('PrinterType', () {
    ...
    test('deprecated top-level bluethoot getter resolves to bluetooth', () {
      // ignore: deprecated_member_use
      expect(bluethoot, PrinterType.bluetooth);
    });

    test('deprecated PrinterTypeLegacy.bluethoot resolves to bluetooth', () {
      // ignore: deprecated_member_use
      expect(PrinterTypeLegacy.bluethoot, PrinterType.bluetooth);
    });
  });
}
